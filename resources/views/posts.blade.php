<x-layout>
    ...
    @foreach ($posts as $post)
        ...
        <article class="py-8 px-6 max-w-screen-md border-b border-gray-300">
        ...
        <div class="">
            ...
            In
            <a href="/category/{{ $post->category->id }}" class="hover:underline text-base text-gray-500">{{ $post->category->name }}</a> | {{ $post['created_at']->diffForHumans() }}
        </div>
